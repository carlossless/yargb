...
impl CPU {
    ...
    const CB_OPS: &'static [Operation] = &[
        dop!("RLC B", &rotate_left_carry!(b)),
        dop!("RLC C", &rotate_left_carry!(c)),
        dop!("RLC D", &rotate_left_carry!(d)),
        dop!("RLC E", &rotate_left_carry!(e)),
        dop!("RLC H", &rotate_left_carry!(h)),
        dop!("RLC L", &rotate_left_carry!(l)),
        dop!("RLC (HL)", &CPU::unimplemented),
        dop!("RLC A", &rotate_left_carry!(a)),
        dop!("RRC B", &rotate_right_carry!(b)),
        dop!("RRC C", &rotate_right_carry!(c)),
        dop!("RRC D", &rotate_right_carry!(d)),
        dop!("RRC E", &rotate_right_carry!(e)),
        dop!("RRC H", &rotate_right_carry!(h)),
        dop!("RRC L", &rotate_right_carry!(l)),
        dop!("RRC (HL)", &CPU::unimplemented),
        dop!("RRC A", &rotate_right_carry!(a)),
        dop!("RL B", &rotate_left!(b)),
        dop!("RL C", &rotate_left!(c)),
        dop!("RL D", &rotate_left!(d)),
        dop!("RL E", &rotate_left!(e)),
        dop!("RL H", &rotate_left!(h)),
        dop!("RL L", &rotate_left!(l)),
        dop!("RL (HL)", &CPU::unimplemented),
        dop!("RL A", &rotate_left!(a)),
