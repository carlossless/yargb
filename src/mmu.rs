    ...
    pub fn write_byte(&mut self, addr: u16, value: u8) {
        match addr {
            ...
            0xFF0F => {
                ...
                println!("interupt_flags {:b}", value);
            }
            0xFF24 => {
                self.channel_control = value;
                println!("channel_control {:b}", value);
            }
            0xFF25 => {
                self.sound_output = value;
                println!("sound_output {:b}", value);
            }
            0xFF26 => {
                self.sound_flags = value;
                println!("sound_flags {:b}", value);
            }
            0xFF40 => {
